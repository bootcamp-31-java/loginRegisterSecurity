 ...
 * @author Aseprudin
 */
@WebServlet(name = "TestServletTable", urlPatterns = {"/TestServletTable"})
public class TestServletTable extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<th>Savings</th>");
            out.println("</tr>");
            out.println("<tr>");
            out.println("<td>1</td>");
            out.println("<td>January</td>");
            out.println("<td>$100</td>");
            out.println("</tr>");
            out.println("<tr>");
            out.println("<td>2</td>");
            out.println("<td>Febuary</td>");
